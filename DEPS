...
vars = {
  ...
  'dart_git': 'https://github.com/levili-T/dart_sdk',
  'flutter_git': 'https://flutter.googlesource.com',
  'skia_git': 'https://skia.googlesource.com',
  'llvm_git': 'https://llvm.googlesource.com',
  'skia_revision': 'fec78c0da2e6a446f873275277ed75d7e328891b',
  ...
  'dart_revision': '64b26137450b1f9c5419e8a9f62af73035ded8eb',

  # WARNING: DO NOT EDIT MANUALLY
  # The lines between blank lines above and below are generated by a script. See create_updated_flutter_deps.py
  'dart_ai_rev': '64dfa7f138aa4d9bcc06e807858136b7d4d296d3',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart':
   Var('dart_git') + '.git' + '@' + Var('dart_revision'),
  ...
  'engine/src/flutter/third_party/dart/third_party/devtools':
   {'dep_type': 'cipd', 'packages': [{'package': 'dart/third_party/flutter/devtools', 'version': 'git_revision:131c9de7c067973d314b2684939c95e0a82b2bdb'}]},
     ...
     'packages': [
       {
        ...
        'version': 'tQAtsLtpc0oBIqRwCAdLYps7dyfBQLYMcLz0l0BZPygC'
       }
     ],
